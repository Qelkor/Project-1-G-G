...
class Goblin {
  ...
  draw() {
    ...
    ctx.drawImage(gob, this.frameX * this.w, this.frameY * this.h, this.w, this.h, this.x, this.y, this.w * 1.5, this.h * 1.5)
  }
}
...
function drawSprite(img, spriteSheetX, spriteSheetY, spriteWidth, spriteHeight, positionX, positionY, positionW, positionH){
    ctx.drawImage(img, spriteSheetX, spriteSheetY, spriteWidth, spriteHeight, positionX, positionY, positionW, positionH);
  }
...
function animate(timestamp){
    ...
    drawSprite(spriteImg, user.w * user.spriteX, user.h * user.spriteY, user.w, user.h, user.x, user.y, user.w * 2, user.h * 2);
    moveSprite();
